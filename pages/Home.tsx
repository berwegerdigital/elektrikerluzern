          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 py-16 lg:py-28">
            ...
            <div className="lg:w-1/2 z-10">
              <div className="inline-block bg-blue-50 border border-blue-100 rounded-full px-4 py-1.5 mb-6">
                <span className="text-[#005eb8] font-bold tracking-wide uppercase text-xs">Elektrikerverzeichnis Zentralschweiz</span>
              </div>
              <h1 className="text-4xl md:text-6xl font-extrabold text-[#0f172a] mb-8 leading-[1.1] tracking-tight">
                Ihr Verzeichnis für <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#005eb8] to-[#009fe3]">
              ...
              <div className="mt-10 flex flex-wrap items-center gap-6 text-sm font-medium text-slate-500">
                <div className="flex items-center gap-2">
                  <CheckCircle size={18} className="text-green-500" /> Unverbindlich
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={18} className="text-green-500" /> Kostenlos
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={18} className="text-green-500" /> Geprüfte Partner
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 relative w-full">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white transform lg:rotate-2 hover:rotate-0 transition duration-500">
                <img 
                  src="./header_bild.png" 
                  alt="Elektriker bei der Arbeit in Luzern" 
                  className="w-full h-auto object-cover aspect-[4/3]"
                  onError={(e) => {
                    // Fallback if local image fails
                    (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=1200";
                  }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a]/60 to-transparent"></div>
                <div className="absolute bottom-6 left-6 text-white">
                    <p className="font-bold text-lg">Professionelles Handwerk</p>
                    <p className="text-sm opacity-90">In Ihrer Region</p>
                </div>
              </div>
              {/* Decorative Element */}
              <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-blue-100/50 -z-10 rounded-full blur-3xl"></div>
              <div className="absolute -top-10 -left-10 w-40 h-40 bg-orange-100/50 -z-10 rounded-full blur-3xl"></div>
            </div>
