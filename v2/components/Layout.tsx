...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-[var(--bg-site)] text-[var(--text-dark)]">
      ...
      {/* Top Bar */}
      <div className="bg-[#0f172a] text-white py-2 text-xs font-medium">
        <div className="container mx-auto px-4 flex justify-between items-center">
            <span>Ihr Verzeichnis für die Zentralschweiz</span>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center gap-8">
            ...
            <Link to="/" className="flex items-center gap-2 group flex-shrink-0">
              <div className="bg-[var(--primary)] text-white p-2 rounded font-bold text-xl">EL</div>
              <span className="text-2xl md:text-3xl font-extrabold text-[#0f172a] tracking-tight group-hover:text-[var(--primary)] transition font-display">
                elektriker<span className="font-light text-[var(--primary)]">luzern.ch</span>
              </span>
            </Link>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-2 mb-6">
               <span className="text-2xl font-extrabold text-white tracking-tight font-display">elektriker<span className="font-light text-[var(--primary)]">luzern.ch</span></span>
            </div>
